...
const AuthControls = () => {
  ...
  // Auto-close modal when route changes (clicking HM / HOME button)
  useEffect(() => {
    setAuthOpen(false);
  }, [location.pathname]);
  ...
  return (
    <>
      {/* LEFT: User Menu */}
      <div className="auth-cluster-left">
        {isAuthenticated && (
            ...
            {menuOpen && (
              <div className="user-dropdown" role="menu">
                <div className="user-dropdown-head">
                  {avatar && <img className="dropdown-avatar" src={avatar} alt="" />}
                ...
                <button type="button" onClick={() => { setMenuOpen(false); navigate('/help'); }}>
                  HELP
                </button>
                  ...
                  <div className="logout-confirm">
                    ...
                    <div className="logout-confirm-actions">
                      <button
                        type="button"
                        className="danger"
                        onClick={() => { setMenuOpen(false); setConfirmLogout(false); logout(); }}
                      >
                        YES
                      </button>
      ...
      {/* RIGHT: LOGIN everywhere when logged out; + NEW MEMORY only on Saved route when logged in */}
      <div className="auth-cluster-right">
        {!isAuthenticated && (
          <button type="button" className="auth-btn primary" onClick={() => openAuth('login')}>
            LOGIN
          </button>
        )}
        ...
        <div className="auth-modal-overlay" onClick={handleBackdropClick}>
          <div className="auth-panel" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className="auth-btn primary auth-submit" disabled={submitting}>
                {submitting ? 'PLEASE WAIT...' : mode === 'login' ? 'SUBMIT' : 'CREATE ACCOUNT'}
              </button>
            </form>
